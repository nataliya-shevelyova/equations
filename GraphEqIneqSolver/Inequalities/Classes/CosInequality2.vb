	...
	Public Class CosInequality2
		...
		Public Overrides ReadOnly Property AllRangeSolutions(ByVal xRange As XRange) As ReadOnlyCollection(Of XRange)
			Get
				...
				Else
					...
					Return PeriodicRangeSolution((-Math.Acos(A) - D) / C, (Math.Acos(A) - D) / C, 2 * Math.PI / C, xRange)
				End If
			End Get
		End Property
		...
		Public Overrides ReadOnly Property TextSolutions() As ReadOnlyCollection(Of String)
			Get
				...
				Return PeriodicSolution(LeftBound, (-Math.Acos(A) - D) / C, (Math.Acos(A) - D) / C, RightBound, "{0} πn".FormatEx(2 / C))
			End Get
		End Property
