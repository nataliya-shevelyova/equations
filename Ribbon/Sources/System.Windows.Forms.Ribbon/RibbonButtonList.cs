...
namespace System.Windows.Forms
{
       ...
       IContainsSelectableRibbonItems, IScrollableRibbonItem, IContainsRibbonComponents
   {
      ...
      private bool _flowToBottom;
	   ...
	   {
		   get { return _noScroll; }
		   set { _noScroll = value; }
	   }

	   private RibbonItem _selectedItem;
	   private bool _noScroll;
      ...
      {
         get { return NoScroll ? ListScrollType.UpDownButtons :  _scrollType; }
      }
      ...
      {
         get { return NoScroll ? 0 : _controlButtonsWidth; }
      ...
      {
		  if(!NoScroll && _scrollBarEnabled) ScrollOffset(-(_jumpDownSize + 1));
      }
      ...
      public override Size MeasureSize(object sender, RibbonElementMeasureSizeEventArgs e)
      {
         ...
         SetLastMeasuredSize(new Size(Math.Max(0, widthSum + ControlButtonsWidth), Math.Max(0, height + 4)));
