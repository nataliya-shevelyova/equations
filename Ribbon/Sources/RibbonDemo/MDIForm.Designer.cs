namespace RibbonDemo
{
   partial class MDIForm
   {
      ...
      private void InitializeComponent()
      {
         ...
         this.ribbon1.Size = new System.Drawing.Size(711, 130);
         ...
         this.ribbonButton1.Text = "Close Form";
         ...
         this.ribbonButton2.Text = "Form 1";
         ...
         this.ribbonButton3.Text = "Form 2";
         ...
         this.ribbonPanel2.Items.Add(this.ribbonCheckBox2);
         this.ribbonPanel2.Items.Add(this.ribbonCheckBox3);
         this.ribbonPanel2.Items.Add(this.ribbonCheckBox4);
         this.ribbonPanel2.Items.Add(this.ribbonCheckBox5);
         this.ribbonPanel2.Items.Add(this.ribbonCheckBox6);
         this.ribbonPanel2.Text = "ribbonPanel2";
         // 
         // ribbonCheckBox1
         // 
         this.ribbonCheckBox1.Text = "Fingerprint";
         // 
         // ribbonCheckBox2
         // 
         this.ribbonCheckBox2.Text = "Expire Date";
         // 
         // ribbonCheckBox3
         // 
         this.ribbonCheckBox3.Text = "Full-ID";
         // 
         // ribbonCheckBox4
         // 
         this.ribbonCheckBox4.Text = "ll11l1l11ll";
         // 
         // ribbonCheckBox5
         // 
         this.ribbonCheckBox5.CheckBoxOrientation = System.Windows.Forms.RibbonCheckBox.CheckBoxOrientationEnum.Right;
         this.ribbonCheckBox5.Text = "Fingerprint";
         // 
         // ribbonCheckBox6
         // 
         this.ribbonCheckBox6.CheckBoxOrientation = System.Windows.Forms.RibbonCheckBox.CheckBoxOrientationEnum.Right;
         this.ribbonCheckBox6.Text = "Expire Date";
         this.ribbonCheckBox6.ToolTip = "Word";
         // 
         // MDIForm
         // 
